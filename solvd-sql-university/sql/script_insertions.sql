...
VALUES
	('2023-09-14','Marketing 1-N',50.50),
    ('2023-09-15','Marketing 2-T',110.21),
    ('2023-08-15','Statistics 1-M',100.00),
    ('2023-05-01','Administration 1-T',150.00),
    ('2023-09-25','Computing 1-N',36.30),
    ('2023-02-21','Computing 3-N',88.60);
    
INSERT INTO Courses(startDate,name,cost)
VALUES
	('2023-02-21','Circuit Analysis 1-N',55.30),
    ('2023-02-21','Circuit Analysis 1-T',50.60),
    ('2023-02-21','Biochemistry 3-M',55.60);
